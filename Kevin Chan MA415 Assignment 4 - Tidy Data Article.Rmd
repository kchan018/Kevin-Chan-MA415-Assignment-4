---
title: "Assignment 4 - Tidy Data Article"
author: "Kevin Chan"
...
xtable(table4[1:10, 1:7], file = "table4.tex")
View(table4)
```
...
xtable(table7[c(1:3, 6:10), 1:8], "table7.tex")
View(table7)

clean <- melt(table7, id = 1:5, na.rm = T)
